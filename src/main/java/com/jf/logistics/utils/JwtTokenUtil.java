...
public final class JwtTokenUtil {
    ...
    // 应用密钥
    private static final String APP_SECRET = "logistics.jf";
     ...
     * 生成Token
     */
    public static String createToken(String username,Object user,String[] roles, long expiration) {
    ...
    public static Object getUser(String token){
       return getTokenClaims(token).get(USER);
    }
